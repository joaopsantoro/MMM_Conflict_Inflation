...
#define MEDL( X, Y ) ( p->med( ( char * ) X, Y ) )
#define MEDS( O, X ) ( CHK_PTR_DBL( O ) O->med( ( char * ) X, 0 ) )
#define MEDLS( O, X, Y ) ( CHK_PTR_DBL( O ) O->med( ( char * ) X, Y ) )
#define PERC( X, Y ) ( p->perc( ( char * ) X, 0, Y ) )
#define PERCL( X, Y, Z ) ( p->perc( ( char * ) X, Y, Z ) )
#define PERCS( O, X, Y ) ( CHK_PTR_DBL( O ) O->perc( ( char * ) X, 0, Y ) )
#define PERCLS( O, X, Y, Z ) ( CHK_PTR_DBL( O ) O->perc( ( char * ) X, Y, Z ) )
